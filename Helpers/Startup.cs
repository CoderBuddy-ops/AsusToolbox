...
public class Startup
{
    ...
    public static void ScheduleCharge()
    {
        ...
        {
            td.RegistrationInfo.Description = "Asus Charge Limit";
    ...
    public static void Schedule()
    {
        ...
        using (TaskDefinition td = TaskService.Instance.NewTask())
        {
            ...
            td.RegistrationInfo.Description = "Asus Auto Start";
            ...
            catch (Exception ex)
            {
                ...
                if (ProcessHelper.IsUserAdministrator())
                    MessageBox.Show("Can't create a start up task. Try running Task Scheduler by hand and manually deleting Asus task if it exists there.", "Scheduler Error", MessageBoxButtons.OK);
                else
                    ProcessHelper.RunAsAdmin();
            }
        }
    ...
    public static void UnSchedule()
    {
        using (TaskService taskService = new TaskService())
        {
            ...
            {
                if (ProcessHelper.IsUserAdministrator())
                    MessageBox.Show("Can't remove task. Try running Task Scheduler by hand and manually deleting Asus task if it exists there.", "Scheduler Error", MessageBoxButtons.OK);
                else
                    ProcessHelper.RunAsAdmin();
            }
        }
