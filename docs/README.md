# Asus - Lightweight control tool for Asus laptops
...
<a href="https://github.com/seerge/g-helper/releases/latest/download/GHelper.exe" alt="Asus - Lightweight control tool for Asus laptops"><img width="1280" alt="Asus - Lightweight control tool for Asus laptops" src="https://raw.githubusercontent.com/seerge/g-helper/refs/heads/main/docs/app-hero.jpg" /></a>
...
- ``Ctrl + Shift + F12`` - Open Asus window
...
> [!NOTE]
> ### 🔖 Important Notice
> Asus is **NOT** an operating system, firmware, or driver. It **DOES NOT** "run" your hardware in real-time anyhow.
> 
...
> 
> The role of Asus for your laptop is similar to the role of a remote control for your TV.
